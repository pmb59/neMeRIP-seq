#Reproducibility assessment with Bioconductor package fCCAC 
#
# Madrigal P (2016). “fCCAC: functional canonical correlation analysis to 
# evaluate covariance between nucleic acid sequencing datasets.” Bioinformatics, 2017
#
######################################################################
#Use 24,877 peaks #
